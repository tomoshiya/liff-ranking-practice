...
**最終更新**: 2026年1月22日 14:45  
**プロジェクト状態**: フェーズ3開始！Firebase SDK導入・接続テスト完了  
**次回セッション予定**: ランキングデータのFirebase移行
...
7. ⬜ **Firebase学習開始**
   - 公式チュートリアルを見る（1時間）
   - Firebaseとは何かを理解する
   - Realtime Databaseの概要を掴む
   - アカウント作成の準備

8. ⬜ **Firebaseアカウント・プロジェクト作成**
   - Googleアカウントでログイン
   - 新しいプロジェクト作成「ふたりのらんきんぐ」
   - Realtime Database 有効化
   - 基本設定

9. ⬜ **Firebase初期導入**
   - index.html に Firebase SDK 追加
   - 設定情報の記述
   - 接続テスト
   - 簡単なデータ保存テスト

### 重要（Firebase導入後）
10. ⬜ **LocalStorage → Firebase 移行**
    - ランキングデータをFirebaseに保存
    - 履歴取得をFirebaseから
    - 動作確認
